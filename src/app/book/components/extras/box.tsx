            ...
            return (
              <div
                ...
                className={`p-4 rounded-lg border ${
                  availableQuantity > 0 ? 'bg-gray-50' : 'opacity-50 bg-gray-100'
                }`}
              >
          ...
          return (
            ...
            >
              <div className="flex items-center space-x-3">
                {/* Checkbox aligned next to the header */}
                <label htmlFor={`trip-${extra.id}`} className="text-lg font-medium text-gray-800">
                  {extra.name}
                </label>
                <input
                  type="checkbox"
